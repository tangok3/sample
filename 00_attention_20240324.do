...
/*
binscatter pi log_visit if pi < 10 & pi > -10 & cons > 20
binscatter l_attention_CPI log_visit if pi == 0 & cons > 20 
binscatter l_attention_com log_visit if pi == 0 & cons > 20 

binscatter l_attention_CPI Q11_1 if pi < 10 & pi > -10 & cons > 20

binscatter l_attention_CPI log_visit if pi < 10 & pi > -10 & cons > 20
binscatter l_attention_CPI log_visit if pi > 0 & pi < 10 & cons > 20
binscatter l_attention_CPI log_visit if pi < 0 & pi > -10 & cons > 20


binscatter l_attention_com log_visit if pi < 10 & pi > -10 & cons > 20
*/
...
g pi_1year  = (Q11_1 - 10000) / 10000 if Q11_1 > 5000 & Q11_1 < 20000
// hist Q11_1 if Q11_1 > 0 & Q11_1 < 20000,percent
// g pi_3year  = Q11_2
// g pi_10year = Q11_3
hist pi_1year,percent
sum pi_1year,d

// binscatter attention_CPI pi_1year
...
duplicates report
duplicates tag id wave,gen(temp)
fre temp
browse if temp == 1

binscatter  l_attention_CPI abs_pi if pi < 10 & pi > -10 & cons > 10 
binscatter  l_attention_CPI abs_pi if abs_pi < 15 & abs_pi > -15 & cons > 10 
binscatter  l_attention_CPI ln_abs_pi if cons > 10
...
binscatter l_attention_CPI pi if pi < 10 & pi > -10 & cons > 10 & Q11_1 == 0, ms(ehuge) line(qfit) rd(0)
binscatter l_attention_CPI pi if pi < 10 & pi > -10 & cons > 10 & Q11_1 >= 10000 & Q11_1 <= 11000, ms(ehuge) line(qfit) rd(0)

ssc install xthreg

duplicates tag id,gen(temp)
fre temp
keep if temp == 41

xthreg attention_CPI cpi, rx(pi) qx(pi) thnum(1) grid(400) trim(0.05) bs(300)
...
oprobit attention_CPI positive_d2 negative_d2 gender age education income i.wave if pi100 > -0.1 & pi100 < 0.1 & cons > 50 & Q11_1 == 0
oprobit attention_CPI positive_d2 negative_d2 gender age education income i.wave if pi100 > -0.1 & pi100 < 0.1 & cons > 50 & Q11_1 >= 9000 & Q11_1 <= 11000
